  ...
  head: () => ({
    meta: [
      ...
      { title: "Help.com — Helping should be simple" },
      {
        name: "description",
        content:
          "Help.com connects donors, volunteers, NGOs, hospitals, and communities across Nepal.",
      },
      { name: "author", content: "Help.com" },
      { property: "og:title", content: "Help.com — Helping should be simple" },
      {
