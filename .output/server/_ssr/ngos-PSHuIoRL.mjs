...
import { a as SiteFooter } from "./site-footer-CzwiNoCM.mjs";
import { C as Check, O as ArrowRight, T as Building2, _ as Funnel, b as CircleCheck, g as Globe, h as Heart, l as Search, m as Mail, n as Users, p as MapPin, u as Phone, v as FolderKanban, w as Calendar } from "../_libs/lucide-react.mjs";
import { t as SiteNav } from "./site-nav-BHtZWTpO.mjs";
import { n as fetchApi, t as DetailModal } from "./apiClient-Du67RRAA.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ngos-PSHuIoRL.js
...
async function getNGOs(filters) {
	const remoteData = await fetchApi("/api/ngos");
	const dataset = remoteData && Array.isArray(remoteData) ? remoteData : ngosDemoData;
