...
import { C as Check, D as Award, E as Briefcase, O as ArrowRight, _ as Funnel, b as CircleCheck, l as Search, o as Star, p as MapPin, r as UserCheck, y as Clock } from "../_libs/lucide-react.mjs";
import { t as SiteNav } from "./site-nav-BHtZWTpO.mjs";
import { n as fetchApi, t as DetailModal } from "./apiClient-Du67RRAA.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/volunteers-8TlpbM2t.js
...
async function getVolunteers(filters) {
	const remoteData = await fetchApi("/api/volunteers");
	const dataset = remoteData && Array.isArray(remoteData) ? remoteData : volunteersDemoData;
