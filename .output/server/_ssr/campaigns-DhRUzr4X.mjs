...
import { C as Check, O as ArrowRight, _ as Funnel, h as Heart, i as Target, l as Search, n as Users, p as MapPin, s as Sparkles, w as Calendar, x as CircleAlert, y as Clock } from "../_libs/lucide-react.mjs";
import { t as SiteNav } from "./site-nav-BHtZWTpO.mjs";
import { n as fetchApi, t as DetailModal } from "./apiClient-Du67RRAA.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/campaigns-DhRUzr4X.js
...
async function getCampaigns(filters) {
	const remoteData = await fetchApi("/api/campaigns");
	const dataset = remoteData && Array.isArray(remoteData) ? remoteData : campaignsDemoData;
